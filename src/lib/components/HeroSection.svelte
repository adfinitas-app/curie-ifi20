...
<div style="background-image: url('/bg-mobile.png')" class=" bg-cover bg-no-repeat  w-screen h-screen md:hidden relative">
    ...
    <div in:fly={{x:-2000, y:100, duration:1000}} style="clip-path: polygon(0 28%, 100% 6%, 100% 83%, 0 100%);" class="w-full bg-[#4D54D6]/60 backdrop-blur-md z-10 h-[45rem] absolute -bottom-72"/>
        <div in:fly={{y: -200, duration:300, delay:1000}} class="absolute text-center flex flex-col items-center justify-center bottom-12 uppercase z-10 w-full text-white">
            <p class="text-[17px] font-Raleway font-black px-3 mb-6">
                Votre don ouvre
                de <span class="underline-red ">nouvelles perspectives</span>
                de guérison aux patients.
                <br>
            </p>
            <p class="font-semibold font-Raleway text-[15px] mb-3 px-2" style="text-transform: none">
...
<div class="bg-[url('/header-desktop-test.png')] hidden bg-fixed bg-cover bg-no-repeat h-screen w-screen relative md:flex items-center justify-center z-10 ">
    ...
    {#if bottomDivVisible}
        ...
        <p in:fly={{y: -200, duration:300, delay:1000}} class="lg:text-[20px] xl:text-[25px] 2xl:text-[35px] 2xl:leading-[3rem] font-Raleway font-black text-white absolute text-center lg:bottom-20  2xl:bottom-40 uppercase z-10">
        ...
        {#if StickyBannerVisible}
            <div in:fade class="absolute bg-transparent lg:bottom-5 xl:bottom-5 2xl:bottom-10 flex flex-col items-center justify-center z-10">
                ...
                <p class="font-Lato text-white text-xl 2xl:text-[3xl] absolute lg:top-[5rem] xl:top-[8rem] text-center lg:w-[40rem] xl:w-[60rem] 2xl:w-[80rem]">
