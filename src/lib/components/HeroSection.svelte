...
<div class="bg-[url('/header-desktop-test.png')] hidden bg-fixed bg-cover bg-no-repeat h-screen w-screen relative md:flex items-center justify-center z-10 ">
    ...
    {#if bottomDivVisible}
        ...
        <svg class="absolute right-20 w-[5rem] xl:w-[8rem] top-[30%] 2xl:top-[30%]" xmlns="http://www.w3.org/2000/svg" width="165.641" height="157.966" viewBox="0 0 165.641 157.966">
