            ...
            <div class="backdrop-blur-xl w-[60rem] 2xl:w-[80rem] bg-white rounded-r-3xl transition-colors rounded-l-3xl rounded-b-3xl  lg:h-[25rem] xl:h-[30rem] 2xl:h-[40rem]">
                ...
                {#if activeTab === 1}
                    ...
                    <div class=" input-focus-orange flex flex-col items-center justify-center 2xl:p-4">
                        ...
                        <a target="_blank" href="https://aider.curie.fr/ifi" class="text-center bg-[#FF6600] uppercase xl:text-xl text-white py-2 xl:py-3 px-10 xl:px-16 font-Raleway font-bold hover:px-20 transition-all absolute -bottom-5 xl:-bottom-10 2xl:bottom-0">
                            JE FAIS UN DON<br/>
                ...
                {:else if activeTab === 2}
                    ...
                    <div class=" input-focus-violet flex flex-col items-center justify-center 2xl:p-4">
                        ...
                        <a target="_blank" href="https://aider.curie.fr/ifi" class="text-center bg-[#4D54D6] uppercase xl:text-xl text-white py-2 xl:py-3 px-10 xl:px-16 font-Raleway font-bold hover:px-20 transition-all absolute -bottom-5 2xl:bottom-0">
                            JE FAIS UN DON<br/>
                            Déductible de<br class="hidden xl:block"/>
